...
class BillBoard_Fragment : Fragment() {
    ...
    //private lateinit var buttonFragmentDescription: Button
    private lateinit var buttonFragmentNewMovie: Button
    ...
    private fun bind(){
        ...
        buttonFragmentNewMovie = view?.findViewById(R.id.btn_link_new_movie) as Button
    }
